...
class MyRecycleViewNeadtedAdapterPay extends RecyclerView.Adapter<MyViewHolderNeadtedPay> {
    private ArrayList<String> arrayListIsNull1cData=new ArrayList<>();
    Context context;
    AsyncTaskLoader<JsonNode> asyncTaskLoader;

    MyViewHolderNeadtedPay myViewHolderNeadtedPay;

    public MyRecycleViewNeadtedAdapterPay(ArrayList<String> arrayListIsNull1cData, Context context, AsyncTaskLoader<JsonNode> asyncTaskLoader) {
    ...
    @Override
    public void onBindViewHolder(@NonNull MyViewHolderNeadtedPay holder, @NonNull int position, @NonNull List<Object> payloads) {
    ...
    @Override
    public void onViewRecycled(@NonNull MyViewHolderNeadtedPay holder) {
        super.onViewRecycled(holder);
    }

    @Override
    public boolean onFailedToRecycleView(@NonNull MyViewHolderNeadtedPay holder) {
    ...
    @Override
    public void onViewAttachedToWindow(@NonNull MyViewHolderNeadtedPay holder) {
        super.onViewAttachedToWindow(holder);

    }

    @Override
    public void onViewDetachedFromWindow(@NonNull MyViewHolderNeadtedPay holder) {
    ...
    @NonNull
    @Override
    public MyViewHolderNeadtedPay onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        try {
            ...
            myViewHolderNeadtedPay = new MyViewHolderNeadtedPay(viewГлавныйВидДляRecyclleViewДляСогласованияISNull,context);
        ...
        return myViewHolderNeadtedPay;

    }

    @Override
    public void onBindViewHolder(@NonNull MyViewHolderNeadtedPay holder, int position) {
        try {
