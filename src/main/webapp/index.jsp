...
<%@ page import="dsu1glassfishatomic.workinterfaces.InSessionFactory" %>
...
<%!
    ...
    long getTheadPoolActive() {
        long TheadPool=Runtime.getRuntime().freeMemory();
        System.out.println( " TheadPool "+TheadPool);
        return TheadPool;
    ...
    long getActiveMaxMemory() {
        long TheadPool=Runtime.getRuntime().maxMemory();
        System.out.println( " TheadPool "+TheadPool);
        return TheadPool;
...
<br><i>---------------------------------------------------------------------------------------------------------</i><br>
<h2>Cтраница   JSP Red Hat Jboss 7 на intellij idea </h2>
...
<h1><i> SSL: <%= request.getServletContext().getAttribute("getsslattrib") %></i></h1>
    <br><i>----------------------------------------------------------------------------------------------------</i><br>
<h1><i> Текущий Пользователь: <%= request.getServletContext().getAttribute("IdUser") %></i></h1>
